...
const SESSION_TOKEN_KEY = 'utel_session_token';
...
// On initialization, try to recover token from sessionStorage
cachedAccessToken = typeof window !== 'undefined' ? getStoredToken() : null;
