        ...
        <div className="bg-[#181818] border border-zinc-800 rounded-2xl p-4 mb-6 text-xs text-gray-400 flex items-start gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="leading-relaxed">
              Este sistema contiene datos confidenciales. Se requiere acceder con una cuenta autorizada.
            </p>
          </div>
        </div>

        {errorMessage && (
          <div className="bg-rose-500/10 border border-rose-500/20 text-rose-400 rounded-xl p-4 mb-5 text-xs font-semibold flex animate-shake">
        ...
        {!showAdminLogin ? (
          ...
          <div className="space-y-4 animate-fadeIn">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                onClick={() => { setShowAdminLogin(false); setErrorMessage(''); }}
                className="text-[10px] text-gray-500 hover:text-gray-300 transition-all font-bold uppercase tracking-widest"
              >
                ← Volver
              </button>
            </div>
